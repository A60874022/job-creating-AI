...
urlpatterns = [
    ...
    path("<int:pk>/", views.ProductDetailView.as_view(), name="product_detail"),  # было product_id
    path("<int:pk>/delete/", views.ProductDeleteView.as_view(), name="product_delete"),
    path("autocomplete/", views.product_autocomplete, name="autocomplete"),

    path("profile/", views.profile, name="profile"),
    # Избранное
    path("favorites/add/<int:pk>/", views.add_to_favorites, name="add_to_favorites"),  # было product_id
    path(
