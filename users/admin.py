...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ['email', 'first_name', 'last_name', 'email_verified', 'is_staff', 'is_active', 'date_joined']
    list_filter = ['email_verified', 'is_staff', 'is_superuser', 'is_active', 'date_joined']
